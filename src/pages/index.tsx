...
import timelineData from "/src/data/timeline.json"
import * as styles from "/src/styles/index.module.scss"
...
export default function IndexPage() {
  ...
  const timelineItems = React.useMemo(() => timelineData.map(item => {
    ...
    let hours = timeline.map(({ from, to, hoursPerDay }) =>
  ...
  function getTableData(item) {
    return (
      <>
        ...
        <td><span>{item.hours.toLocaleString('en-US')}+</span></td>
      </>
    )
  }
